...
> 작성일: 2026-05-25 / 최근 갱신: 2026-06-15 v0.1.14 — 출시 준비 종합(빈 운동계획·완료 토글 근본수정 + 전수감사 + 재발방지)
> 작성 기준: v0.1.14 (versionCode 28) — 출시 준비 종합(빈 운동계획=R8 keep 갭·완료 토글 해제 보존=수동 우선 + 전수감사 출시차단 해소 + 재발방지, PR #122) (이전: v0.1.13 코드베이스 리팩토링 #107~#112 / v0.1.12 HC 체성분 가져오기 제거·권한 회수·수동 단일화 / v0.1.11 Play Store 계정 삭제·완전성 + HC 권한 rationale(Android 14+ 무반응) / v0.1.9 HC 체중·체지방 가져오기 + 오늘의 활동 + 갤럭시 워치 온보딩)
