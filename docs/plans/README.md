...
|---|---|---|---|---|
| 2026-09-20 | meal-plan-api-selection | design | approved | meal-plan, api-selection, azure-ai-foundry, deepseek, maas, implementation |

## Topic Ledgers (완료 작업 history)

- [Android](logs/android.md) — recent 0, older 21
- [Backend](logs/backend.md) — recent 0, older 4
- [Dependencies](logs/dependencies.md) — recent 1, older 6
- [Process & Infra](logs/process-infra.md) — recent 6, older 20
